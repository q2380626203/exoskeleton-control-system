...
### v3.0 (2025年1月24日) - 纯蓝牙控制版
- 📱 **全新Web蓝牙控制系统**：实现BLE低功耗蓝牙与Web应用的实时通信
- 🎛️ **动态参数调整**：支持通过Web界面实时调整所有助力参数，无需重新编译代码
- 📊 **实时状态传输**：向Web应用实时传输电机状态、运动识别结果和系统参数
- 🖥️ **远程监控界面**：提供友好的Web界面进行系统监控和参数调整
- 🔧 **参数持久化**：支持参数的动态修改和实时生效
- 🛡️ **保留核心功能**：完整保留v2.1的智能力矩控制和静止检测系统

### v2.1+ (2025年1月23日) - 智能力矩控制系统
